...
use App\Domains\Identity\Http\Resources\LoginResource;
use App\Domains\Identity\Http\Resources\ProfileResource;
use Illuminate\Support\Facades\Password;

use App\Domains\Identity\Services\Auth\RegisterService;
...
class AuthController extends Controller
{
    ...
    public function login(LoginRequest $request)
    {
        ...
        } catch (\App\Domains\Identity\Exceptions\Auth\IPSpamException $e) {
            return $e->render($request);
        } catch (\App\Domains\Identity\Exceptions\Auth\AccountLockedException $e) {
            return $e->render($request);
        } catch (\App\Domains\Identity\Exceptions\Auth\CaptchaRequiredException $e) {
            return $e->render($request);
        } catch (\App\Domains\Identity\Exceptions\Auth\InvalidCredentialsException $e) {
            $response = [
                'message' => $e->getMessage()
            ];
